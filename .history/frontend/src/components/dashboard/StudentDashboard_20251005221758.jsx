...
import StudentPaymentInterface from '../student/StudentPaymentInterface';
...
const StudentDashboard = () => {
  ...
  const tabs = [
    ...
    { value: 'payment-interface', label: 'Payment Interface', icon: <CreditCard className="w-4 h-4" /> },
