...
import TeacherPaymentDashboard from '../teacher/TeacherPaymentDashboard';
import TeacherSubscriptionSystem from '../teacher/TeacherSubscriptionSystem';
import PaymentAnalytics from '../teacher/PaymentAnalytics';
import PaymentReminderSystem from '../teacher/PaymentReminderSystem';
...
const TeacherDashboard = () => {
  ...
  const tabs = [
    ...
    { value: 'payment-dashboard', label: 'Payment Dashboard', icon: <CreditCard className="w-4 h-4" /> },
    { value: 'subscription', label: 'Subscription', icon: <CreditCard className="w-4 h-4" /> },
    { value: 'analytics', label: 'Analytics', icon: <CreditCard className="w-4 h-4" /> },
    { value: 'reminders', label: 'Reminders', icon: <Bell className="w-4 h-4" /> },
    ...
    >
      {selectedBatch ? (
        ...
        <>
          ...
          {activeTab === 'payment-dashboard' && (
            <TeacherPaymentDashboard
              batches={teacherBatches}
              students={teacherStudents}
            />
          )}
