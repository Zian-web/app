  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const mappedData = {
        ...
        max_students: batchData.student_limit || 30,
          ...
          {showPaymentBlock && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-3">
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 text-red-800 mb-3">
                  <AlertTriangle className="h-5 w-5" />
                  <h3 className="text-base font-semibold">Payment Required to Create Batch</h3>
                </div>
