  ...
  const handlePayNow = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Check for payment URL in various possible structures (same as TeacherSubscription)
        ...
        if (paymentUrl) {
          ...
          toast({
            title: "Payment Error",
            description: "No payment URL received from server. Response: " + JSON.stringify(data),
            variant: "destructive"
          });
        }
      } else {
