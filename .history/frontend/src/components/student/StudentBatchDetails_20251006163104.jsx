...
const StudentBatchDetails = ({ batch, onBack, currentUser }) => {
  ...
  const fetchTeacherInfo = async () => {
    ...
    try {
      // Since the teacher endpoint doesn't exist, we'll assume teacher has online payment enabled
      // This can be updated when the backend provides the correct endpoint
      console.log('Teacher info endpoint not available, assuming online payment enabled');
