  ...
  useEffect(() => {
    const fetchBatchPayments = async () => {
      try {
        ...
        // If no payments found, create a sample payment for testing
        if (batchPayments.length === 0) {
          console.log('No payments found for batch, creating sample payment');
          const samplePayment = {
            id: Date.now(),
            batch_id: batch.id,
          ...
          setStudentPayments([samplePayment]);
        } else {
