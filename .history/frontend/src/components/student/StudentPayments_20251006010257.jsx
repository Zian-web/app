...
const StudentPayments = () => {
  ...
  const fetchPayments = async () => {
    try {
      ...
      // If no data returned, create some mock data for testing
      if (paymentsData.length === 0) {
        console.log('No payments data found, creating mock data for testing');
        const mockPayments = [
          {
            id: 1,
            batch_id: 1,
  ...
  const fetchPaymentSummary = async () => {
    try {
      ...
      // If no summary data returned, create some mock data for testing
      if (!summaryData) {
        console.log('No summary data found, creating mock data for testing');
        const mockSummary = {
          total_payments: 2,
          paid_amount: 0,
          due_amount: 3000,
