...
const SimpleUpgradeButton = () => {
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      // Create Razorpay account (backend should use stored teacher data)
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button 
              ...
              disabled={isLoading || !formData.bankAccountNumber || !formData.ifscCode || !formData.accountHolderName}
