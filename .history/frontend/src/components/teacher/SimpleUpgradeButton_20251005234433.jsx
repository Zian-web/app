...
const SimpleUpgradeButton = () => {
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      // Sends: email, full_name, phone_number, bank_account_number, ifsc_code, bank_name, account_type
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button 
              ...
              disabled={isLoading || !formData.bankAccountNumber || !formData.ifscCode || !formData.accountHolderName || !formData.email || !formData.phoneNumber}
