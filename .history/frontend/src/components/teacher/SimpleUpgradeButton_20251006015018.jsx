...
const SimpleUpgradeButton = () => {
  ...
  const checkPaymentStatus = async () => {
    try {
      ...
      if (teacherData && teacherData.requires_online_payment) {
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      // Frontend sends: email, full_name, phone_number, bank_account_number, ifsc_code, bank_name, account_type, address
      // Backend automatically adds: type="route", business_type="individual", profile
