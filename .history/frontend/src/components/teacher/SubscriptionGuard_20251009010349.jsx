...
const SubscriptionGuard = ({ 
  ...
  const getActionMessage = () => {
    if (requiresPayment) {
      switch (action) {
        case 'create_batch':
          return 'You need to complete your subscription payment before creating new batches.';
        case 'upload_material':
          return 'You need to complete your subscription payment before uploading materials.';
        case 'access_materials':
          return 'You need to complete your subscription payment before accessing materials.';
        default:
          return 'You need to complete your subscription payment to perform this action.';
      }
    } else {
      switch (action) {
        case 'create_batch':
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2 justify-center">
            ...
            <Button variant="outline" onClick={() => window.location.href = '/teacher/dashboard?tab=subscription'}>
