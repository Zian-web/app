  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (paymentsData.status === 'fulfilled') {
        ...
        console.log('Payment structure:', allPayments.map(p => ({ 
          id: p.id, 
          batch_id: p.batch_id, 
        ...
        // Add batch name to each payment and deduplicate
        const paymentsWithBatchName = batchPayments.map(payment => ({
          ...payment,
        ...
        const uniquePayments = paymentsWithBatchName.reduce((acc, payment) => {
        ...
        console.log('Deduplicated payments:', uniquePayments.length, 'from', paymentsWithBatchName.length);
