...
import PdfViewerDialog from '../common/PdfViewerDialog'; // ✅ your viewer dialog
        ...
        <div className="space-y-6">
            ...
            {viewingPdf && (
                <PdfViewerDialog
                    ...
                    pdfUrl={viewingPdf.pdfUrl}   // ✅ corrected
                                    ...
                                    <Button 
                                        ...
                                        onClick={() => {
                                            if (!material.file_url) {
                                                toast({
                                                    title: 'Error',
                                                    description: 'PDF URL is missing',
                                                    variant: 'destructive'
                                                });
                                                return;
                                            }
                            ...
                            <CardContent>
                                <div className="space-y-1 text-sm">
                                    <p className="text-muted-foreground">
                                        Batch: {getBatchName(material.batch_id)}
                                    </p>
                                    <p className="text-muted-foreground">
                                        Uploaded: {material.upload_date ? format(new Date(material.upload_date), 'PPP') : 'Unknown date'}
                                    </p>
