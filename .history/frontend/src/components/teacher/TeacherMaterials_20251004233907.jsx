    ...
    <div className="space-y-6">
      ...
      <div className="space-y-8">
        {isLoading ? (
          ...
          Object.entries(groupedMaterials).map(([batchId, batchMaterials]) => (
            <Card key={batchId}>
              <CardHeader>
                <CardTitle>{getBatchName(batchId)}</CardTitle>
              </CardHeader>
                    ...
                    <CardHeader className="flex flex-row items-start justify-between space-y-0">
                      ...
                      <div className="flex items-start gap-2 ml-4">
                        <Button
                          ...
                          variant="ghost"
                          onClick={() =>
                            setViewingPdf({ pdfUrl: material.access_url, title: material.title })
                          }
                        >
