...
const TeacherPayments = () => {
  ...
  const fetchPayments = async () => {
    try {
      ...
      if (paymentsData.length === 0) {
        console.log('No teacher payments found, creating sample data');
        const samplePayments = [
          {
            id: 1,
            student_name: 'John Doe',
            batch_name: 'Math Batch 1',
            amount: 1000,
            payment_status: 'due',
  ...
  const fetchPaymentSummary = async () => {
    try {
      ...
      // If no summary data, create some sample data for testing
      if (!summaryData) {
        console.log('No teacher summary found, creating sample data');
        const sampleSummary = {
          total_revenue: 2000,
          total_due: 1000,
          total_paid: 1000,
        ...
        setPaymentSummary(sampleSummary);
      } else {
