...
const TeacherPayments = () => {
  ...
  const fetchPayments = async () => {
    try {
      ...
      const response = await api.get(ENDPOINTS.PAYMENTS.TEACHER.LIST);
  ...
  const fetchPaymentSummary = async () => {
    try {
      const response = await api.get(ENDPOINTS.PAYMENTS.TEACHER.SUMMARY);
  ...
  const sendPaymentReminders = async () => {
    try {
      await api.post(ENDPOINTS.PAYMENTS.REMINDERS.SEND);
      toast({
        title: "Success",
