...
const TeacherSubscriptionManager = ({ teacherId }) => {
  ...
  const createSubscription = async (plan = 'basic') => {
    try {
      ...
      console.log('ENDPOINT:', ENDPOINTS.SUBSCRIPTION.TEACHER.CREATE);
      console.log('Full URL:', `${API_BASE_URL}${ENDPOINTS.SUBSCRIPTION.TEACHER.CREATE}?plan=${plan}`);
            ...
            <TabsContent value="overview" className="space-y-4">
              ...
              {subscriptionStatus && subscriptionStatus.subscription_active && (
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Check the Subscriptions tab for details</p>
                </div>
              )}
            </TabsContent>
