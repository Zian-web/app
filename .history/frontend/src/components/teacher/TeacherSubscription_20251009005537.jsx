                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge variant={subscription.is_due ? 'destructive' : subscription.payment_status === 'paid' ? 'default' : 'secondary'}>
                          {subscription.is_due ? 'Payment Due' : subscription.payment_status === 'paid' ? 'Paid' : 'Pending'}
                        </Badge>
                      </div>
