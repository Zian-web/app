      ...
      <div className="subscription-info bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <p className="text-gray-700">
              <span className="font-medium">Effective Students:</span> {Math.max(subscription.current_student_count || 0, 20)}
            </p>
          </div>
        </div>
      ...
      <div className="subscription-details bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <p className="text-gray-700">
              <span className="font-medium">Effective Students:</span> {Math.max(batch.current_student_count || 0, 20)}
            </p>
          </div>
        </div>
          ...
          statusResponse.subscriptions.map(async (subscription) => {
            try {
              ...
              return {
                ...subscription,
                ...calculationResponse,
                monthly_fee: calculationResponse.subscription_calculation?.total_subscription || subscription.monthly_fee,
                ...
                commission_per_student: calculationResponse.subscription_calculation?.commission_per_student || 0
              };
            } catch (error) {
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
              ...
              <div className="mt-4">
                <Button 
                  ...
                  size="sm"
                  onClick={() => {
                    // Refresh subscription data to recalculate fees
                    fetchSubscriptionData();
                    toast({
                      title: "Recalculating Fees",
                      description: "Subscription fees are being recalculated based on current batch data.",
                    });
                  }}
