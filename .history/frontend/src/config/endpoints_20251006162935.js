...
export const ENDPOINTS = {
    ...
    PAYMENTS: {
        ...
        STUDENT: {
            ...
            PAYMENT_REDIRECT: (batchId) => `/api/student/batch/${batchId}/payment-redirect`,
            CREATE_PAYMENT_LINK: (batchId, months) => `/api/student/batch/${batchId}/create-payment-link?months=${months}`,
