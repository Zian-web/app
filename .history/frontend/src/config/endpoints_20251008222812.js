...
export const ENDPOINTS = {
    ...
    SUBSCRIPTION: {
        ...
        ADMIN: {
            TOGGLE_BETA: '/api/admin/subscription/toggle-beta',
            STATUS: '/api/admin/subscription/status',
            CHECK_EXPIRY: '/api/admin/subscription/check-expiry',
            SEND_REMINDERS: '/api/admin/subscription/send-reminders',
            LOCK_BATCH: (batchId) => `/api/admin/batch/${batchId}/lock`,
            UNLOCK_BATCH: (batchId) => `/api/admin/batch/${batchId}/unlock`,
            REMINDERS: '/api/admin/subscription/reminders',
            CONFIG: '/api/admin/subscription/config',
            UPDATE_CONFIG: '/api/admin/subscription/update-config'
        }
    },
    RAZORPAY: {
        ACCOUNT: {
